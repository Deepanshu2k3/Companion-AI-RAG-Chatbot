...
export default function Home() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-b from-gray-50 to-gray-100">
      ...
      <header className="bg-gradient-to-r from-blue-600 to-indigo-700 text-white py-6 px-8 shadow-lg">
      ...
      <main className="flex-grow px-4 py-8 md:px-8">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
                ...
                <div className="mt-6 bg-white rounded-xl shadow-md p-6 border border-gray-100">
                  ...
                  <ul className="space-y-2 text-sm text-gray-600">
                    <li className="flex items-start">
                      ...
                      Share your LinkedIn or GitHub profile for personalized responses
                    </li>
                    <li className="flex items-start">
                      <svg 
                        className="h-5 w-5 mr-2 text-green-500 flex-shrink-0" 
                      ...
                      Ask specific questions related to your interests or industry
                    </li>
                    <li className="flex items-start">
                      <svg 
                        className="h-5 w-5 mr-2 text-green-500 flex-shrink-0" 
            ...
            {/* Chat Interface section - larger column */}
      ...
      <footer className="bg-gray-800 text-white py-8 px-6">
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div>
              ...
              <p className="text-gray-400 text-sm">
                Your AI-powered assistant that learns from your profile to provide personalized responses.
              </p>
            </div>
            <div>
          ...
          <div className="border-t border-gray-700 mt-8 pt-8 text-center text-gray-400 text-sm">
            <p>&copy; {currYear} Companion Chatbot. All rights reserved. Built with ❤️ by Deepanshu</p>
          </div>
        </div>
      </footer>
    </div>
